...
git clone https://github.com/TYRBadingBuilds/device_xiaomi_sm8350-common -b CLOVER_BRANCH device/xiaomi/sm8350-common
...
git clone https://github.com/TYRBadingBuilds/vendor_xiaomi_vili -b lineage-22.2-wip vendor/xiaomi/vili
  
# Vendor common
echo 'Cloning common vendor tree'
git clone https://github.com/TYRBadingBuilds/vendor_xiaomi_sm8350-common -b lineage-22.2-wip vendor/xiaomi/sm8350-common
